            ...
            <div className='container mx-auto '>
                ...
                <div className="grid grid-cols-1 md:px-0 px-3 md:grid-cols-2 gap-5  py-6">
                    ...
                    <div>
                        ...
                        <Image className='rounded-lg' src={product?.imageUrl} alt={"this"} height={300} width={1200} />
                    ...
                    <div className='flex items-center justify-center '>
                        ...
                        <div className='flex flex-col gap-3 sm:gap-10 md:w-[80%] '>
                            ...
                            <div className='p-1 bg-[#029FAE] w-fit text-white rounded-2xl text-sm px-2'>
                              {product?.orignalPrice +".00 USD" || "$20.00 USD"}
                            </div>
                            <hr />
                            <p className='text-[#272343]'>{product?.description||"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam tincidunt erat enim. Lorem ipsum dolor sit amet, consectetur adipiscing Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam tincidunt erat enim. Lorem ipsum dolor sit amet, consectetur adipiscing"}</p>
